...
BEGIN
    ...
    BEGIN
        ...
        FROM (VALUES
            ...
            ('seguimientoAgendaOperadorRol','(solo en JSON)',               'string', 'supervisor, promotor',                                     N'Rol que agendó'),
            ...
            ('numeroRecibo',                'numero_recibo',                'string', 'ej. B135/300 ANEXO 75/300',                                N'Serie + anexo del recibo (texto completo)'),
